...
// Init paresseuse : les tables sont créées au premier accès (pas à l'import),
// pour ne pas toucher la base pendant le build Next.
...
function ensureSchema(): Promise<void> {
  if (!schemaReady) {
    schemaReady = (async () => {
      ...
      // Réinitialise pour permettre un nouvel essai au prochain appel
      schemaReady = null;
      throw err;
    });
  }
